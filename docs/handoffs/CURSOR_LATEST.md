...
| Lane B sleeve still **1c** live | YES (PR #85 paint, PR #86 score) | YES (asset `fdb86b18`) | **CLEARED 6/6 — LOCKED, do not reopen sleeve paint** |
| Temporal live activation | YES (PR #88, `TEMPORAL_LIVE_ACTIVATION_ARMED = true`) | **NO — redeploy `temporal-propagate-proxy` only** | **YES after** that one edge redeploy (Lane C) |
