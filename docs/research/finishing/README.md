...
**Work-order (F2):** [GitHub #103](https://github.com/fendifrost-dot/ai-video-tool/issues/103) · stretch [#114](https://github.com/fendifrost-dot/ai-video-tool/issues/114) · sprint [GitHub #102](https://github.com/fendifrost-dot/ai-video-tool/issues/102)  
...
| [PORTABILITY.md](./PORTABILITY.md) | **F2 stretch** — second clip/project uses the same contract (no demo allowlist) |
...
| [fixtures/second_clip_handoff.json](./fixtures/second_clip_handoff.json) | Synthetic second project/clip sidecar (not demo-locked) |
| [fixtures/second_clip_recipe.json](./fixtures/second_clip_recipe.json) | Matching UXP recipe bound to the second `project_id` |
...
| `src/lib/automation/finishingHandoff.ts` | Reconstructed-master sidecar validator + identity factory; does not block E2E |
...
**Lane state:** F READY (architecture + harness). **F2 READY** (handoff contract + second-clip portability). Does not block AVT engineering or Lane H E2E.
