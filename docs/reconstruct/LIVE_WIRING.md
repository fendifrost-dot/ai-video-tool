...
**Status:** **READY** — wiring armed; dispatch still requires `explicitArm`. **No edge function.**
...
5. Publish ≠ edge redeploy. Frontend Publish is not this lane.
