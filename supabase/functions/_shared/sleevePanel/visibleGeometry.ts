/** Edge mirror of src/lib/sleevePanel/visibleGeometry.ts — keep in sync. */
/**
...
import type { BinaryMask, QuadNorm, QuadPts, SleeveSide } from "./types.ts";
import { CROSSED_ARMS_VISIBILITY } from "./types.ts";
import { countMask, intersectMasks, quadNormToPts, rasterizeQuadMask } from "./raster.ts";
