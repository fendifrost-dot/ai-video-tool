 ...
 * on-model reference (`referenceMode: "full_look"`, on-model + flat). Not yet run: xAI
 * credit/limit was exhausted the day it was written. Cap/glasses/shoes stay Fendi's own
