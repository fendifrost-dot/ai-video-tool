/**
 * GitHub-verified Stage 1k chest scorecard (Cursor live verification, PR #66).
 * Evidence: docs/research/results/2026-09-04-still-repair/ARCHITECTURE_C_STILL_REPAIR_STAGE1K_RESULT_2026-09-15.md
 *
 * Live ≠ fixture: the real-crop 1k pipeline predicted 9/11 (FAIL C2+C6).
 * Canonical live (asset c9c4efee, ImageScript-decoded source, unfiltered mid-luma)
 * is 7/11 (FAIL C2+C4+C6+C9). Stage 1l goldens target those remaining FAILs.
 */
