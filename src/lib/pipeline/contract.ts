    ...
    laneSurfaces: [
      {
        ...
        notes:
          "Same Lovable edge function as chest. Sleeve paint is Lane B `repairVisibleSleevePanelsOnStill` (`architecture_c_sleeve_still_1c`). Do not reopen logo_chest 1m.",
      },
      {
        ...noPaidCalls,
