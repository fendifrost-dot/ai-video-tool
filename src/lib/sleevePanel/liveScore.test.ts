...
describe("Lane B sleeve live scorecard", () => {
  ...
  it("passes C5/C11/reserved/visible on the 720×1280 synthetic live adapter", () => {
    ...
    expect(score.inputLineage.preferredChestOutputUsed).toBe(false);
  });

  it("locks the canonical live 1a score (fde270bf, NOT CLEARED 5/6)", () => {
