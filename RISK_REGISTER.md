...
Last reviewed: **2026-09-16** (Lane R REL-2 notes-vs-flag YELLOW; real-media locks UNCLAIMED — issue #115).
...
| [RECONSTRUCT-1](#reconstruct-1--gate-4-wiring-without-live-sam-3--new-edge) | Gate 4 wiring without live SAM-3 / new edge; **E2E $0 click PASS 9/9** (`paidCalls=false`, `frames=5`) | Medium | Confirmed | **In-remediation** (click path proven; live 720×1280 / SAM-3 not claimed) | Products (AVT) / Lane D |
