...
- **Pointer:** [`docs/reconstruct/PLAYABLE_EXPORT_LIVE_INCOMPLETE_2026-09-16.md`](docs/reconstruct/PLAYABLE_EXPORT_LIVE_INCOMPLETE_2026-09-16.md); [`docs/reconstruct/PLAYABLE_ARTIFACT.md`](docs/reconstruct/PLAYABLE_ARTIFACT.md); `src/lib/reconstruct/playable/`; issue [#111](https://github.com/fendifrost-dot/ai-video-tool/issues/111); related [#128](https://github.com/fendifrost-dot/ai-video-tool/issues/128) / [PR #129](https://github.com/fendifrost-dot/ai-video-tool/pull/129).
- **DoD (target):** playable MP4 + claims + E2 hook + `video-qa.json` committed; `npm run reconstruct:playable`; parent Publishes frontend only. **Live 8-frame click:** INCOMPLETE 2/9 `fail=0` `mp4=produced` (2026-09-16 ~1:19 AM CT). **Not claimed:** decoded-frame E2 PASS (`frames=0`); live decode of storage bytes for master `76fe7438` (row is 1080×1920 HDR); live SAM-3 fetch; CLEARED real-media gate.
- **Mitigations:** reusable `PlayableClipSpec`; fail-closed SAM-3; `paidCalls=false`; no eval/temporal-QA/pipeline/paint edits.
