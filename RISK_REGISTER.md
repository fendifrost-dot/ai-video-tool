...
- **DoD (target):** playable MP4 + claims + E2 hook committed; `npm run reconstruct:playable`; parent Publishes frontend only. **Not claimed:** live decode of storage bytes for master `76fe7438` (row is 1080×1920 HDR); live SAM-3 fetch; E2 scoring implementation.
